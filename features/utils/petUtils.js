import { Prefix, S2DPacketOpenWindow, S2FPacketSetSlot, getPetItem, sendWindowClick } from "./utils";
    ...
    constructor() {
        ...
        register("packetReceived", (packet, event) => {
            ...
            for (let line of itemLore) {
                ...
                if (line.removeFormatting().toLowerCase().startsWith("click to despawn!")) {
                    ChatLib.chat(Prefix + "&aPet already equipped")
                    return;
                }
            }


            // if (item?.getLore()?.includes("§5§o§7§cClick to despawn!")) return;
            ...
            ChatLib.chat(Prefix + "&aSelecting &c" + itemName);
